'use client'; // Ensure this is correctly spelled as 'use client'
...
const Banner = () => {
  ...
  return (
    <div className="h-[90vh] relative"> {/* Added relative positioning */}
      ...
      <div className="bannerMiniContainer px-36">
        ...
        <div className="bg-white pt-5">
          <div className="flex items-center justify-around">
            ...
            >
              <p className="text-white font-semibold">Search <span className="text-green-400">TransitXpert</span></p>
          ...
          {/* <div className="mt-10 border">
            ...
            {/* <img 
              ...
              src="/carBannar.png" // Ensure the image path is correct
              alt="Car Banner" // Provide descriptive alt text
              style={{ height: '100px', width: '100%' }} // Set fixed height and full width
            /> */}
          {/* </div> } */}
        </div>
      </div>
